  ...
  public: {
    Tables: {
      ...
      hil_notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "hil_notifications_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
      ...
      sla_tracking: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sla_tracking_task_execution_id_fkey"
      ...
      task_executions: {
        Row: {
          ...
          id: string
          input_data: Json
          interrupt_type: Database["public"]["Enums"]["interrupt_type"] | null
        ...
        Relationships: [
          {
            foreignKeyName: "task_executions_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "agents"
            referencedColumns: ["id"]
