...
export function AgentStatus() {
  const [agents] = useState<Agent[]>([
    ...
    },
    {
      ...
      current_tasks: 2,
      max_tasks: 4,
      last_activity: '2024-01-15T12:28:00Z'
    },
    {
      name: 'Cassy',
        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          ...
          <div className="mt-2 bg-gray-200 rounded-full h-2">
            <div 
              ...
              style={{ 
                width: `${(agents.reduce((sum, agent) => sum + agent.current_tasks, 0) / agents.reduce((sum, agent) => sum + agent.max_tasks, 0)) * 100}%` 
              }}
            ></div>
          </div>
        </div>
